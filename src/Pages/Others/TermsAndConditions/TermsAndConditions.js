...
const TermsAndConditions = () => {
    return (
        <div>
            <h1 className='text-success'>Our terms and conditions</h1>
            <p><small>Welcome to Vamous news protal!
                ...
                By accessing this website we assume you accept these terms and conditions. Do not continue to use Vamous News protal if you do not agree to take all of the terms and conditions stated on this page.
                ...
                Cookies
                We employ the use of cookies. By accessing Vamous News protal, you agreed to use cookies in agreement with the Company Name's Privacy Policy.

                Most interactive websites use cookies to let us retrieve the user's details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.

                License
                Unless otherwise stated, Company Name and/or its licensors own the intellectual property rights for all material on Vamous News protal. All intellectual property rights are reserved. You may access this from Vamous News protal for your own personal use subjected to restrictions set in these terms and conditions.

                You must not:

                Republish material from Vamous news protal
                Sell, rent or sub-license material from Vamous News protal
                Reproduce, duplicate or copy material from Vamous News protal
                Redistribute content from Vamous News protal
                ...
                As long as the website and the information and services on the website are provided free of charge, we will not be liable for any loss or damage of any nature.</small></p>
